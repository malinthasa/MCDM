...
for iteration in xrange(10, 80, 5):
    ...
    performance_column = np.zeros((filtering_combinations.shape[0],1), dtype=int)

    reporting = np.append(reporting,performance_column,axis=1)
    ...
    get_top_decisions = calculations.get_indexes_descending(sum, iteration)
